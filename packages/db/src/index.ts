...
import { pendingMigrations } from "./migration-plan";
...
async function createSql(): Promise<Sql> {
  ...
  return databaseUrlNow() ? createNeonSql() : createPgliteSql();
}
...
export function ensureDbReady(): Promise<void> {
  if (databaseUrlNow()) return Promise.resolve();
...
if (typeof window === "undefined" && !databaseUrlNow()) {
