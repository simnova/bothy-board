...
// Local `npm run dev` (port 8080 contract) plus Portless named hosts
// (`https://bothy-board.localhost`, worktrees `https://<branch>.bothy-board.localhost`).
...
const portlessUrl = env("PORTLESS_URL");
const LOCAL_DEV_ORIGINS: string[] = [
  "http://localhost:8080",
  "http://127.0.0.1:8080",
  "http://[::1]:8080",
  "https://bothy-board.localhost",
  "http://bothy-board.localhost",
  "https://*.localhost",
  "http://*.localhost",
  "https://*.*.localhost",
  "http://*.*.localhost",
